package ca.uwaterloo.eclipse.refactoring.test;
...
public class MatchingTest extends TestCase {
	...
	public MatchingTest(String fileNameId, String obtainedMatch) throws IOException {
			
		byte[] encoded = Files.readAllBytes(Paths.get("C:/Users/g_pana/workspace/ca.concordia.jdeodorant.eclipse.commandline/optimal_solution/"+fileNameId+".txt"));
	...
	public void test() {
		...
		if(obtainedMatchIsOptimal == true)
			System.out.println("Optimal Solution Matched!"); 
		else
	...
	public static void main(String args[]) {
        org.junit.runner.JUnitCore.main("ca.concordia.jdeodorant.eclipse.commandline.test.MatchingTest");
   }
}
