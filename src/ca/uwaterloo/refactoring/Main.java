package ca.uwaterloo.refactoring;

import ca.uwaterloo.refactoring.build.RFStatementBuilder;
import ca.uwaterloo.refactoring.mapping.InputMethods;
import ca.uwaterloo.refactoring.node.RFStatement;
import ca.uwaterloo.refactoring.cli.CLIParser;
import ca.uwaterloo.refactoring.utility.ExcelFileColumns;
import ca.uwaterloo.refactoring.mapping.ClonePairInfo;
import ca.uwaterloo.refactoring.mapping.PDGSubTreeMapperInfo;
import ca.uwaterloo.refactoring.diff.TextDiff;
import ca.uwaterloo.refactoring.template.GenericManager;
import ca.uwaterloo.refactoring.template.RFTemplate;
import ca.uwaterloo.refactoring.utility.FileLogger;
import ca.uwaterloo.refactoring.visitor.ChildrenVisitor;
...
public class Main implements IApplication {
                ...
                if (userSkippedGroup || repeatedCloneGroup || classLevelClone) {
                    ...
                    for (int firstCloneNumber = 0; firstCloneNumber < cloneGroupSize - 1; firstCloneNumber++) {
                        ...
                        for (int secondCloneNumber = firstCloneNumber + 1; secondCloneNumber < cloneGroupSize; secondCloneNumber++) {
                            ...
                            generateTemplate(clonePairInfo);
    ...
    private void generateTemplate(ClonePairInfo pairInfo) {
    ...
    private void analyze(CloneStructureNode root) {
        if (root != null) {
