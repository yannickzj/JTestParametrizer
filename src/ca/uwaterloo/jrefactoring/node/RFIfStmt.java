...
public class RFIfStmt extends RFStatement {

    public RFIfStmt(StatementType statementType, Statement statement1, Statement statement2, List<RFNodeDifference> nodeDifferences, RFTemplate template) {
