...
public class RFLabeledStmt extends RFStatement {

    public RFLabeledStmt(StatementType statementType, Statement statement1, Statement statement2, List<RFNodeDifference> nodeDifferences, RFTemplate template) {
