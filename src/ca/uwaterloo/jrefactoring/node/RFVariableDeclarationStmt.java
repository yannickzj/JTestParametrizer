...
public class RFVariableDeclarationStmt extends RFStatement {

    public RFVariableDeclarationStmt(StatementType statementType, Statement statement1, Statement statement2, List<RFNodeDifference> nodeDifferences, RFTemplate template) {
