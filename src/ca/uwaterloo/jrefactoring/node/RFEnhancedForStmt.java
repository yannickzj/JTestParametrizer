...
public class RFEnhancedForStmt extends RFStatement {

    public RFEnhancedForStmt(StatementType statementType, Statement statement1, Statement statement2, List<RFNodeDifference> nodeDifferences, RFTemplate template) {
